...
>
> **最后更新：2026-09-16**（**R016 靶标重发**：用户拍板取消真实逻辑载荷
> （400KB 体积太大），回到单打印惯例形态（151KB）。代码层三项改进保留：
> ㉜ VM 多赋值语义修复 + 槽池扩容 + swap_multi 语料；㉝ 词表长字符串化；
> ㉞ 一趟流水融合自研压缩——大载荷管线能力在位，未来可随时启用。
> 前序：㉞ 自研压缩 → ㉝ 词表长字符串化 → ㉜ R016 大载荷回合 → ㉛ R014
