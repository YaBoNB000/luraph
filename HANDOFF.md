...
>
> **最后更新：2026-09-07**（选项B 双落地：增量⑱ 输入绑定/激活门
> `--bind-key`（引导链第一层门控化，错/缺钥匙即引导层崩溃）+ 增量⑲
> CPS 去中心化尾调用链/蹦床（中心分派循环废除，分派面全入加密碎片，
> 全局 hook 咽喉点消失）。官方矩阵 246/246 + 预设 465/465 + 多种子
> 0 失败 + 绑定门 10/10 + 轮廓 34/34×32 + **安全指纹 34/34×5/5**
> （增量⑳ 附带把 S5 口径校准到 P4 形态后首次全绿））
...
指令级 JIT。计划 `docs/plan-resemblance-and-security.md` |
